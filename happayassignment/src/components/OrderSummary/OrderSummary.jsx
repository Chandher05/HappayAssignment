  ...
  return (
    <div className='md:px-32 m-4 container'>
      ...
      <div className=" grid grid-cols-2 gap-1 content-center ">
            ...
            if (item.count > 0) {
              return (
                <div key={item.id} className='grid grid-cols-3'>
                  ...
                  <div className='m-3 p-3 font-semibold text-xs text-gray-500'>{item.name}</div>
        ...
        <div className='box border border-grey-100 bg-blue-50 p-4'>
